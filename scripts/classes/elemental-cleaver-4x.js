...
try {
    if (args[0].macroPass === "postActiveEffects") {
        ...
        new foundry.applications.api.DialogV2({
            ...
            submit: async result => {
                ...
                if (selectedWeapon) {
                    ...
                    //let baseFormula = selectedWeapon.system.damage.base.formula; // update for 4.x
                    ...
                    // build the damage parts for 3.x
                    let newDamageParts = foundry.utils.duplicate(selectedWeapon.system.damage.parts);
                    newDamageParts[0][0] = baseFormula;
                    newDamageParts[0][1] = damageType;
                        ...
                        changes: [
                            {
                                ...
                                value: `{} (${damageType} Infused)`,
                                priority: 20
                            },
                            {
                                key: 'system.damage.parts',
                                mode: CONST.ACTIVE_EFFECT_MODES.OVERRIDE,
                                value: newDamageParts,
                                priority: 21
                            }
                        ]
                    };
                    ...
                    // addDependent
                    await HomebrewEffects.enchantItem(selectedWeapon, enchantData, {parentEntity: rageEffect});
        ...
        // TODO revert the weapon ??? hopefully the dependent logic handles it
    }
