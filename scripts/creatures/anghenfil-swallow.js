/*
    The anghenfil makes one bite attack against a Medium or smaller target it is grappling. If the attack hits, the
    target is also swallowed and the grapple ends. While swallowed, the creature is Blinded and Restrained, it has total
    cover against attacks and other effects outside the anghenfil, and it takes 21 (6d6) acid damage at the start of
    each of the anghenfil's turns.

    If the anghenfil takes more than 30 damage on a single turn from a creature inside it, the anghenfil must succeed on
    a DC 23 Constitution saving throw at the end of the turn or regurgitate all swallowed creatures, which all fall
    Prone in a space within 10 feet of the anghenfil. If the anghenfil dies, a swallowed creature is no longer
    restrained by it and can escape from the corpse using 15 feet of movement, exiting prone.
 */
const version = "12.3.0";
const optionName = "Anghenfil Swallow";
