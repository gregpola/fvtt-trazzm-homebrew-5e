await game.dfreds.effectInterface.addEffect({effectName:'Fire Shield', uuid:token.actor.uuid});

game.FireShieldHookClientSpecificTokenUuid = token.document.uuid;

game.FireShieldHookClientSpecificId = Hooks.on("updateActor", 
	async (actor,update,diff,userId) => {
